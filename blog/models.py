...
class Reporter(models.Model):
    ...
    reporter_id   = models.ForeignKey(User, on_delete= models.CASCADE, primary_key= True)
    ...
    def __str__(self):
        return self.reporter_id.username
...
class Question(models.Model):
    ...
    def __str__(self):
        return self.reporter.__str__() + " Đã bình luận trong bài " + self.article.__str__()
